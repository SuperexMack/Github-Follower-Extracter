...
var caller = function () { return __awaiter(void 0, void 0, void 0, function () {
    var config, response, followers, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                response = _a.sent();
                followers = parseHTML(response.data);
                if (followers) {
...
var parseHTML = function (htmlContent) {
    var $ = cheerio_1.default.load(htmlContent);
    var followerCount = $('span.text-bold').first().text().trim();
